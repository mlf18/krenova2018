    ...
    <br>
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title" align="center">
                  <a href="#" >Alat tangkap ikan ramah lingkungan sebagai solusi pengganti tangkap cantrang </a>
                </h4>
                <h5>Aziz Tarsono</h5>
         ...
         <br><a href="">Selengkapnya</a></p>
              ...
              <div class="card-footer">
                <small class="text-muted"><a href="" class="btn-sm btn btn-primary"><i class="icon-like"></i></a></small> 75 
                <small class="text-muted"><a href="" class="btn-sm btn btn-danger"><i class="icon-eye"></i></a></small> 100 
        ...
        <small class="text-muted"><a href="" class="btn-sm btn btn-info"><i class="icon-share"></i></a></small>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
                 <small class="text-muted"><a href="" class="btn-sm btn btn-primary"><i class="icon-like"></i></a></small> 22 
        <small class="text-muted"><a href="" class="btn-sm btn btn-danger"><i class="icon-eye"></i></a></small> 30 
        <small class="text-muted"><a href="" class="btn-sm btn btn-info"><i class="icon-share"></i></a></small>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
                  <small class="text-muted"><a href="" class="btn-sm btn btn-primary"><i class="icon-like"></i></a></small> 37 
        <small class="text-muted"><a href="" class="btn-sm btn btn-danger"><i class="icon-eye"></i></a></small> 60 
        <small class="text-muted"><a href="" class="btn-sm btn btn-info"><i class="icon-share"></i></a></small>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
        <small class="text-muted"><a href="" class="btn-sm btn btn-primary"><i class="icon-like"></i></a></small> 3 
        <small class="text-muted"><a href="" class="btn-sm btn btn-danger"><i class="icon-eye"></i></a></small> 20 
        <small class="text-muted"><a href="" class="btn-sm btn btn-info"><i class="icon-share"></i></a></small>
      </div>
            </div>
          </div>
